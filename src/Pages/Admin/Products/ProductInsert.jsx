		...
		<div className='w-100 mt-5' style={{ display: 'flex', height: '85%', justifyContent: 'space-evenly' }}>
			<div style={{ display: 'flex', flexDirection: 'column' }}>
				<div className='mb-3'>
					...
					<input autoComplete='none' type="text" className="form-control" id="name" placeholder="Nombre del producto" />
				</div>
				<div className='mb-3'>
					<label htmlFor="Price" className="form-label">Precio</label>
					<input autoComplete='none' type="text" className="form-control" id="Price" placeholder="Precio" />
				</div>
			...
			<div style={{ display: 'flex', flexDirection: 'column' }}>
				<div className='mb-3'>
					...
					<input autoComplete='none' type="password" className="form-control" id="Category" placeholder="Categoría" />
				</div>

				<div className='mb-3'>
					<label htmlFor="Description" className="form-label">Descripción</label>
					<input autoComplete='none' type="text" className="form-control" id="Description" placeholder="Descripción" />
				</div>
